" ~/.vim/sessions/AUDownloader.vim:
" Vim session script.
" Created by session.vim 2.4.9 on 12 août 2014 at 21:40:22.
...
badd +17 include/MainWindow.hpp
badd +1 source/MainWindow.cpp
badd +27 include/LocalTab.hpp
badd +1 source/LocalTab.cpp
badd +27 include/OnlineTab.hpp
badd +22 source/OnlineTab.cpp
" argglobal
silent! argdel *
set stal=2
edit Makefile
...
setlocal fen
silent! normal! zE
let s:l = 28 - ((19 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
