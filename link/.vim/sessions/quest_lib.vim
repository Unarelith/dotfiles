" ~/.dotfiles/link/.vim/sessions/quest_lib.vim:
" Vim session script.
" Created by session.vim 2.13.1 on 15 décembre 2018 at 01:19:06.
...
setlocal fen
silent! normal! zE
let s:l = 109 - ((39 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
109
...
setlocal fen
silent! normal! zE
let s:l = 23 - ((13 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
...
setlocal fen
silent! normal! zE
let s:l = 54 - ((35 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
54
