" ~/.dotfiles/link/.vim/sessions/MacroConfuence.vim:
" Vim session script.
" Created by session.vim 2.13.1 on 22 février 2019 at 11:08:56.
...
setlocal fen
silent! normal! zE
let s:l = 52 - ((25 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
